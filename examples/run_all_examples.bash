...
cd $bd/read_annot && g++ -std=c++11 -I../../include/ read_annot.cpp -o read_annot && ./read_annot && cd ..

echo "$apptag ========== Running curv example... =========="
cd $bd/read_curv && g++ -std=c++11 -I../../include/ read_curv.cpp -o read_curv && ./read_curv && cd ..

echo "$apptag ========== Running label example... =========="
cd $bd/read_label && g++ -std=c++11 -I../../include/ read_label.cpp -o read_label && ./read_label && cd ..
...
cd $bd/descriptor_info && g++ -std=c++11 -I../../include/ descriptor_info.cpp -o descriptor_info && ./descriptor_info && cd ..

echo "$apptag ========== Running vertex color export example... =========="
cd $bd/vertex_color_export && g++ -std=c++11 -I../../include/ vertex_color_export.cpp -o vertex_color_export && ./vertex_color_export && cd ..
